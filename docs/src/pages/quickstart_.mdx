...
Get the Authenticator binary [here](https://github.com/cyralinc/approzium/tree/develop/authenticator), then run it with
...
see [our Python guide](/languages-python) for how to configure them.)
```python
