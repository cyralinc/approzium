...
| --log_level        | APPROZIUM_LOG_LEVEL        | info       |                                             |
| --log_format       | APPROZIUM_LOG_FORMAT       | text       |                                             |
| --log_raw          | APPROZIUM_LOG_RAW          | false      |                                             |
| --vault_token_path | APPROZIUM_VAULT_TOKEN_PATH |            |                                             |
| --config           | APPROZIUM_CONFIG_FILE_PATH | config.yml |                                             |
