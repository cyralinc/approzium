...
| --vaulttokenpath   | APPROZIUM_VAULT_TOKEN_PATH |            | Optional, if set it will cause the latest Vault token to always be pulled from the given file. This option takes precedence over --vaulttoken                                                                                                                                                                                                                             |
| --vaulttoken       | VAULT_TOKEN                |            | Optional, if set it will be used at the Vault token.                                                                                                                                                                                                                                                                                                                      |
| --vaultaddr        | VAULT_ADDR                 |            | Required if using Vault as the secrets manaager.                                                                                                                                                                                                                                                                                                                          |
| --awsregion        | AWS_REGION                 |            | Required if using AWS Secrets Manager as the secrets manager.                                                                                                                                                                                                                                                                                                             |
