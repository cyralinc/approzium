...
_PASSWORDREQUEST = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='identity', full_name='approzium.authenticator.protos.PasswordRequest.identity',
...
_PASSWORDREQUEST.oneofs_by_name['identity'].fields.append(
  _PASSWORDREQUEST.fields_by_name['aws'])
_PASSWORDREQUEST.fields_by_name['aws'].containing_oneof = _PASSWORDREQUEST.oneofs_by_name['identity']
