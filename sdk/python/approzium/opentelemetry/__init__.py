...
def instrument():
    """Instruments Opentelemetry ``opentelemetry.instrumentation.dbapi`` to automatically include
...
def uninstrument():
    """Removes Approzium instrumentation from Opentelemetry ``opentelemetry.instrumentation.dbapi``

    :raises: Exception, if ``opentelemetry.instrumentation.dbapi`` was not instrumented by Approzium
    """
