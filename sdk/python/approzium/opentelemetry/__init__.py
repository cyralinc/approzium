...
def instrument():
    """Instruments Opentelemetry ``opentelemetry.instrumentation.dbapi`` to
    automatically include attribution tags in traces generated by Approzium
    database connections. Call this method before calling the ``instrument``
    method provided by Opentelemetry database extensions.
